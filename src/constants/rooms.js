export const ROOMS = [
  {
    ...
    presentations: [
      { session: 'S1', time: '10:05-10:20', presenter: '伯煜昆 Walker', topic: '國策院－臺灣政府如何維持現狀' },
  ...
  },
  {
    ...
    presentations: [
      { session: 'S1', time: '10:05-10:20', presenter: '林小聖 Sage', topic: '黑田視覺整合－人際關係對小型設計公司的重要性' },
      ...
      { session: 'S3', time: '13:50-14:05', presenter: '范露莎 Larissa', topic: '自閉症總會－自閉症患者在職場的溝通策略' },
  ...
  },
  {
    ...
    presentations: [
      ...
      { session: 'S1', time: '10:50-11:05', presenter: '徐芯怡 Katherine', topic: '陽交大－醫療影像(X射線)與物質相互作用的屏蔽機制' },
      ...
      { session: 'S3', time: '14:05-14:20', presenter: '羅福山 Sean', topic: '工研院－防禦科技產業供應鏈的全球化' },
      { session: 'S3', time: '14:20-14:35', presenter: '蘇蘭珺 Sophia', topic: '工研院－防禦科技產業供應鏈的全球化' },
      { session: 'S4', time: '14:45-15:00', presenter: '詹彬禮 Brooklyn', topic: 'AI 與自主機器人在半導體製造產業中的應用：機械工程師角色的轉變' },
      { session: 'S4', time: '15:00-15:15', presenter: '楊怡珠 Emma', topic: '崧旭資訊－共享開發文件在軟體發展中的重要性' },
      { session: 'S4', time: '15:15-15:30', presenter: '郭恩美 Amy', topic: '金融研訓院－人工智能在招募流程中的應用' },
    ],
  },
];
